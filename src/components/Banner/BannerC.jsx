...
export default function BannerC({ base, v, whatsappLink, scrollToSection }) {
  return (
    <section
      id="inicio"
      className="relative min-h-screen bg-black flex items-center pt-20 overflow-hidden"
      style={{
        backgroundImage: `url(${base}images/banner3/banner3ok.png${v})`,
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center md:min-h-[calc(100vh-5rem)]">
        ...
        <div>
          ...
          <p className="mt-6 text-lg text-neutral-400 max-w-2xl leading-relaxed border-l-4 border-[#D4AF37] pl-6 italic">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <button
              ...
              className="px-8 py-4 border border-neutral-700 hover:border-[#D4AF37] text-neutral-200 hover:text-[#D4AF37] rounded-sm font-semibold transition-all text-center uppercase tracking-wide text-sm"
            >
              Ver Servicios
            </button>
          </div>
        ...
        <div className="relative z-20 flex justify-center md:justify-end md:self-stretch md:h-full md:items-end">
          <img
            ...
            onError={(e) => {
              ...
              e.currentTarget.src = `${base}images/banner3/hero2svg.svg${v}`;
            }}
          />
        </div>
      </div>
